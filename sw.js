...
const CORE = [
  ...
  // Bibliaolvasás modul: a súlytábla és a könyvlista kicsi -> precache.
  ...
  // Edzésnapló: a gyakorlat-katalógus (~32 KB) offline is kell.
  "./exercises.json",
  // Kalóriaszámláló: a magyar alap-ételbázis (~30 KB) offline is kell.
  "./food-db.json"
];
